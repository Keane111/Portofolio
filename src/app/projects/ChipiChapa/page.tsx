...
export default function ChipiChapaPage() {
  const handleGithubClick = () => {
    window.open('https://github.com/Keane111/ChipiChapa', '_blank');
  };
        ...
        <FadeIn delay={0.1}>
          <div className="mb-16">
            ...
            <div className="flex items-center justify-between mb-12">
              <h2 className="text-4xl font-bold text-gray-900">ChipiChapa</h2>
        ...
        <FadeIn delay={0.3}>
          <div className="mb-16">
            <div className="bg-white border border-gray-200 shadow-lg">
              <img src="/ChipiChapa.png" alt="ChipiChapa Application Interface" className="w-full h-auto" />
            </div>
          </div>
        </FadeIn>
